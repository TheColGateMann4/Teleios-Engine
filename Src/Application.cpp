...
void Application::InitializeScene()
{
	...
	//scene.AddSceneObjectFromFile(graphics, "Assets/Models/nanosuit/nanosuit.obj");
	scene.AddSceneObjectFromFile(graphics, "Assets/Models/sponza/sponza.obj", 1.0f / 40.0f);
	//scene.AddSceneObjectFromFile(graphics, "Assets/Models/intel_sponza/main1_sponza/NewSponza_Main_Yup_003.fbx", 1.0f);
	//scene.AddSceneObjectFromFile(graphics, "Assets/Models/intel_sponza/pkg_a_curtains/NewSponza_Curtains_FBX_YUp.fbx", 1.0f);

	//scene.AddSceneObjectFromFile(graphics, "Assets/Models/intel_sponza/main1_sponza/NewSponza_Main_glTF_003.gltf");
	//scene.AddSceneObjectFromFile(graphics, "Assets/Models/intel_sponza/pkg_a_curtains/NewSponza_Curtains_glTF.gltf");
	//scene.AddSceneObjectFromFile(graphics, "Assets/Models/intel_sponza/pkg_b_ivy/NewSponza_IvyGrowth_glTF.gltf");
	//scene.AddSceneObjectFromFile(graphics, "Assets/Models/intel_sponza/pkg_c_trees/NewSponza_CypressTree_glTF.gltf");
